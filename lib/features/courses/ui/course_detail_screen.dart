                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      if (hasDiscount) ...[
                                                        ...
                                                        Text('egularPrice', style: const TextStyle(color: Colors.white38, decoration: TextDecoration.lineThrough, fontSize: 12)),
                                                        const SizedBox(height: 6),
                                                        Text('✓ وفر %', style: const TextStyle(color: Colors.greenAccent, fontSize: 12, fontFamily: 'Cairo', fontWeight: FontWeight.bold)),
                                                      ],
                                                    ],
                                                  ),
